...
BOOST_FIXTURE_TEST_SUITE(Car_Controller, CarContollerFixture)
	...
	BOOST_FIXTURE_TEST_SUITE(when_car_is_turn_on, when_car_turned_on_)
		...
		{
			VerifyCommandHandling("SetGear 1", "Condition of gear box has been changed\n");
		}
		...
		{
			VerifyCommandHandling("SetGear -1", "Condition of gear box has been changed\n");
			VerifyCommandHandling("SetSpeed 5", "Speed has been changed\n");
			VerifyCommandHandling("Info", "Car is turned on\nDirection is reverse\nSpeed is 5\nCondition of gear box is -1\n");
			VerifyCommandHandling("SetGear 0", "Condition of gear box has been changed\n");
			VerifyCommandHandling("SetGear -1", "Condition of gear box has not been changed\n");
			VerifyCommandHandling("Info", "Car is turned on\nDirection is reverse\nSpeed is 5\nCondition of gear box is 0\n");
		}
		BOOST_AUTO_TEST_CASE(cannot_switch_from_reverse_gear_when_speed_more_zero)
		{
			VerifyCommandHandling("SetGear -1", "Condition of gear box has been changed\n");
			VerifyCommandHandling("SetSpeed 20", "Speed has been changed\n");
			VerifyCommandHandling("Info", "Car is turned on\nDirection is reverse\nSpeed is 20\nCondition of gear box is -1\n");
			VerifyCommandHandling("SetGear 1", "Condition of gear box has not been changed\n");
			VerifyCommandHandling("SetGear 2", "Condition of gear box has not been changed\n");
			VerifyCommandHandling("SetGear 3", "Condition of gear box has not been changed\n");
			VerifyCommandHandling("SetGear 4", "Condition of gear box has not been changed\n");
			VerifyCommandHandling("SetGear 5", "Condition of gear box has not been changed\n");
			VerifyCommandHandling("Info", "Car is turned on\nDirection is reverse\nSpeed is 20\nCondition of gear box is -1\n");
		}
		BOOST_AUTO_TEST_CASE(cannot_switch_gear_when_gear_out_of_range)
		{
			VerifyCommandHandling("SetGear 6", "Condition of gear box has not been changed\n");
			VerifyCommandHandling("Info", "Car is turned on\nDirection is still\nSpeed is 0\nCondition of gear box is 0\n");
		}
